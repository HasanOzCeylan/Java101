...
public class AirWaysTicket {
     ...
     * Take the fare per distance as 0.10 $ / km.
     ...
     */
        public static void main(String[] args) {
            ...
            distance = input.nextDouble();                   //Take the distance from user.
            System.out.print("Enter your age:");
            age = input.nextInt();                           //Take the age from user.
            System.out.print("Enter the flight type (One way = 1 || Round Trip = 2: ");
            flightType  = input.nextInt();                   //Take the type of flight (One way or Round-trip) from user.
